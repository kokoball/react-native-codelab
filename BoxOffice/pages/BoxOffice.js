...
function BoxOffice(props) {
    ...
    React.useEffect(()=>{
        // ajax 비동기 자바스크립트 XML    
        fetch('http://www.kobis.or.kr/kobisopenapi/webservice/rest/boxoffice/searchDailyBoxOfficeList.json?key=25939726bc7824dd2668cfa62d1bb1a8&targetDt=20210703')
           .then( data => {
